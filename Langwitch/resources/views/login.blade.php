        ...
        <div class="container">
            ...
            <form class="middle">
                ...
                <div>
                    ...
                    <img id="password-eye" class="hide-password" src="{{ asset('images/EyeClosed.svg') }}"
                        onclick="reveal_password('password')"></img>
                </div>
                <div style="display: none;">
                    ...
                    <img id="confirmation-eye" class="hide-password" src="{{ asset('images/EyeClosed.svg') }}"
                        onclick="reveal_password('confirmation')"></img>
                </div>
